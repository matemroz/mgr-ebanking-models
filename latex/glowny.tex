...
Ze względu na fakt, że w przyszłości planowane są kolejne modernizacje oraz rozszerzenia, system musi wykazywać się dużą skalowalnością. Istotne jest również, żeby tworzony system posiadał optymalną ziarnistość oraz zapewniał reużywalność usług. 
...
Proces biznesowy \quotedblbase Obsługa przelewu międzynarodowego\textquotedblrigh jest podobny do procesu występującego już we FrostRes \quotedblbase Obsługa przelewu krajowego\textquotedblrigh. Zasadnicza różnica polega na możliwości automatycznej wymiany waluty na zgodną z krajem, do którego wysyłany jest przelew.

\begin{figure}[h!tbp]
\begin{centering}
\includegraphics[width=16cm, height=17cm]{img/bmm_model_frostres.png}
