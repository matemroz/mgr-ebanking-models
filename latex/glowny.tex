...
Rozdział ten podsumowuje badania nad metodą projektowania architektury korporacyjnej. 

Autorska metoda zostanie porównana do innych, obecnie występujących podejść. Nastąpi również próba oceny przydatności oraz możliwości wykorzystania metody w realnych projektach systemów informatycznych.
