...
Modele w rozdziale zostały przygotowane z wykorzystaniem narzędzia firmy IBM - Rational Software Architect - w wersji 8.5 wraz z doinstalowanym dodatkiem do obsługi języka SoaML.
...
\TODO: opis serwera, na który będzie wdrażany system, opis procesu budowania aplikacji

\section{Testy}
\TODO: Opis jakim testom poddano utworzony system oraz wyniku

\section{Cel systemu w odniesieniu do zaprojektowanej koncepcji}
\TODO: Opisanie czy było możliwe utworzenie systemu opierając się na koncepcji metody. Czy dodano jakieś modyfikacje w tym celu itp.
