...
\begin{figure}[h!tbp]
\begin{centering}
\includegraphics[width=9cm]{img/ea.png}
...
\item{kompozycyjność - zasada kompozycyjności (ang. Composability) jest związana~z~zachowaniem odpowiednich relacji między komponentami. Systemy, które podążają za ta zasadą cechują się możliwością łączenia swoich komponentów~w~różne kombinacje~w~celu spełnienia postawionych wymagań. Umiejętność efektywnego komponowania usług~z~już istniejących elementów jest kluczowym wymogiem do osiągnięcia niektórych~z~podstawowych celów przy tworzeniu systemów opierających się na architekturze zorientowanej na usługi.}
